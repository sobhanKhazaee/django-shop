...
class ArticelComments(models.Model):
    article = models.ForeignKey(Aticel,on_delete=CASCADE,verbose_name="مقاله")
    parent = models.ForeignKey('ArticelComments',on_delete=CASCADE,null=True,blank=True,verbose_name="")