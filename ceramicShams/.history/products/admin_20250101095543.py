...
class productAdmin(admin.ModelAdmin):
    ...
    def get_changeform_initial_data(self, request, obj):
        """
        مقداردهی اولیه فیلدها هنگام باز کردن صفحه ویرایش.
        """
        if obj:  # بررسی اینکه آیا محصول موجود است یا نه
            return {'slug': ''}  # فیلد اسلاگ را خالی کن
        return super().get_changeform_initial_data(request, obj)
