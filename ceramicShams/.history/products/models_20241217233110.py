...
class Product(models.Model):
    ...
    rate = models.IntegerField(null=True, validators=[
                               MinValueValidator(1), MaxValueValidator(5)], editable=False, verbose_name='امتیاز')
# ستون برای آپلود عکس
    ...
    tags =  models.ManyToManyField(
        ProductTags, related_name='related_product', verbose_name='محصولات مرتبط')
...
class ProductTags(models.Model):
    ...
    relatedProducts = models.ManyToManyField(
        Product, related_name='related_product', verbose_name='محصولات مرتبط')
