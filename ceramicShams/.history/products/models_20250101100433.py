...
from jalali_date import get_jalali_create_date
...
class Product(models.Model):
    ...
    slug = models.SlugField(max_length=50, verbose_name='اسلاگ', unique=True,null=True,blank=True)
    is_active = models.BooleanField(
        default=False, verbose_name='فعال/غیر فعال')
    created_at = models.DateTimeField(auto_now_add=True,verbose_name="ایجاد در")  # زمان ایجاد
