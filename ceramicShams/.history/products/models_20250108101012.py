...
class ProductsVisit(models.Model):
    ...
    user = models.ForeignKey(User,on_delete=CASCADE,blank=True,null=True,verbose_name="کاربر")
    Product = models.ForeignKey(Product,on_delete=CASCADE,verbose_name="محص")
