...
urlpatterns = [
    ...
    path('sort-by-brand/<int:brand_id>/',views.SortByBrandView.as_view(), name='sortByBrand'),
    path('filter-by-price/', views.FilterByPriceView.as_view(), name='filter_by_price'),
