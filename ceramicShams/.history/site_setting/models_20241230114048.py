...
class SiteSetting(models.Model):
    ...
    logo = models.ImageField(upload_to="site/image", verbose_name="لوگوی سایت"و,null=True,blank=True)
    icon = models.ImageField(upload_to="site/image", verbose_name="آیکون سایت",null=True,blank=True)
