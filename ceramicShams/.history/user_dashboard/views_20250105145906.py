...
class EditProfileView(View):
    ...
    def post(self, request):
        ...
        if edit_form.is_valid():
            edit_form.save()
            return render(request, "edit_profile.html", {'form': edit_form, 'current_user': current_user, 'success': True})
        else:
            return render(request, "edit_profile.html", {'form': edit_form, 'current_user': current_user, 'success': False})
