...
class FactorsView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        current_cart = Cart.objects.filter(user_id=self.request.user.id, payment=False).first()
        context['total_price'] = current_cart.total_price()
        return context
