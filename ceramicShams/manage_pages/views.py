...
class indexPageView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['home_top_banner'] = Banner.objects.filter(active=True,position = "home_top").exists()
        context['home_middle_banner'] = Banner.objects.filter(active=True,position = "home_middle").exists()
